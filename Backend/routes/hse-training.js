...
// GET list
router.get('/training', protect, async (req, res) => {
  try {
...
// GET single
router.get('/training/:id', protect, async (req, res) => {
  try {
    const { id } = req.params;
...
// POST create
router.post('/training', protect, async (req, res) => {
  try {
    ...
    // Build placeholders - uniform $N for all values
...
// PATCH
router.patch('/training/:id', protect, async (req, res) => {
  try {
    const { id } = req.params;
...
// DELETE
router.delete('/training/:id', protect, async (req, res) => {
  try {
    const { id } = req.params;
