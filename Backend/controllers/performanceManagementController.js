// controllers/performanceManagementController.js
...
/**
 * Generate reference number: PMT-YYYY-{random8chars}
 */
...
export async function createTask(req, res) {
  ...
  try {
    ...
    console.error("performance createTask error:", err);
    throw err;
  } finally {
    client.release();
  }
...
export async function listTasks(req, res) {
  ...
  try {
    ...
    console.error("performance listTasks error:", err);
    throw err;
  } finally {
    client.release();
  }
...
/**
 * getTaskById
 * GET /api/performance-management/:id
 */
export async function getTaskById(req, res) {
  ...
  try {
    ...
    console.error("performance getTaskById error:", err);
    throw err;
  } finally {
    client.release();
  }
...
export async function updateTask(req, res) {
  ...
  try {
    ...
    console.error("performance updateTask error:", err);
    throw err;
  } finally {
    client.release();
  }
...
/**
 * deleteTask
 * DELETE /api/performance-management/:id
 */
export async function deleteTask(req, res) {
  ...
  try {
    ...
    console.error("performance deleteTask error:", err);
    throw err;
  } finally {
    client.release();
  }
