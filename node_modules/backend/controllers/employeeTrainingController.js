// controllers/employeeTrainingController.js
...
/**
 * Generate reference number: EMPT-YYYY-{random8chars}
 */
function generateReference() {
  ...
  return `EMPT-${year}-${random}`;
}

/**
 * createTask
 * POST /api/employee-training
...
export async function createTask(req, res) {
  ...
  try {
    ...
    console.error("employee training createTask error:", err);
    throw err;
  } finally {
    client.release();
  }
...
export async function listTasks(req, res) {
  ...
  try {
    ...
    console.error("employee training listTasks error:", err);
    throw err;
  } finally {
    client.release();
  }
...
export async function getTaskById(req, res) {
  ...
  try {
    ...
    console.error("employee training getTaskById error:", err);
    throw err;
  } finally {
    client.release();
  }
...
export async function updateTask(req, res) {
  ...
  try {
    ...
    console.error("employee training updateTask error:", err);
    throw err;
  } finally {
    client.release();
  }
...
/**
 * deleteTask
 * DELETE /api/employee-training/:id
 */
export async function deleteTask(req, res) {
  ...
  try {
    ...
    console.error("employee training deleteTask error:", err);
    throw err;
  } finally {
    client.release();
  }
