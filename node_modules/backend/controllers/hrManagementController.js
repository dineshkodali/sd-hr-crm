// controllers/hrManagementController.js
...
/**
 * Generate reference number: HRM-YYYY-{random8chars}
 */
function generateReference() {
  ...
  return `HRM-${year}-${random}`;
}

/**
 * createTask
 * POST /api/hr-management
