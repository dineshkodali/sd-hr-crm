    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between z-10 relative mb-2">
                ...
                <button className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-600 transition-colors border border-gray-200">
                    Export
                </button>
            </div>
            ...
            <div className="flex-1 flex flex-col sm:flex-row items-center gap-4 relative z-10">
                ...
                <div className="w-full sm:w-1/2 space-y-2">
                    {[
                        ...
                        <div
                            key={item.label}
                            className="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors group/item"
            ...
            {donutTooltip.open && (
                <div
                    className="fixed z-[80] px-3 py-2 rounded-lg shadow-lg border border-gray-100 bg-slate-900 text-white text-xs select-none pointer-events-none transform -translate-x-1/2 -translate-y-full mt-[-10px]"
                    style={{
                        left: donutTooltip.x,
                        top: donutTooltip.y,
                        minWidth: 120,
