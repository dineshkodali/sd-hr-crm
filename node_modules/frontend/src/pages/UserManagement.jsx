            ...
            <div className="flex items-center gap-3">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="bg-white border-2 border-gray-200 rounded-lg !pl-14 pr-4 py-2.5 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 w-full transition-all shadow-sm hover:shadow-md"
                />
              </div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="bg-white border border-gray-300 rounded-lg !pl-14 pr-10 py-2.5 text-sm text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all cursor-pointer appearance-none min-w-[140px]"
                >
