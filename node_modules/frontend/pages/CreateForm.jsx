    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-10 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button 
            onClick={handleSave} 
            className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-lg shadow-md transition-all font-medium active:scale-95"
          >
        ...
        {/* Status Notification */}
        {status && (
          <div className={`mb-6 p-4 rounded-lg flex items-center gap-3 shadow-sm border ${
            status.type === 'error' 
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border-gray-300 border p-2.5 rounded-lg focus:ring-2 focus:ring-orange-200 focus:border-orange-500 outline-none transition-all text-sm font-mono bg-gray-50" 
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border-gray-300 border p-2.5 rounded-lg focus:ring-2 focus:ring-orange-200 focus:border-orange-500 outline-none transition-all text-sm" 
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {fields.map((f, idx) => (
                  <div key={idx} className="group relative bg-white border border-gray-200 hover:border-orange-300 rounded-lg p-4 transition-all shadow-sm hover:shadow-md">
                    ...
                    <div className="pl-6 grid grid-cols-1 sm:grid-cols-12 gap-4 items-start">
                      ...
                      <div className="sm:col-span-3">
                        ...
                        <select 
                          ...
                          className="w-full border border-gray-300 rounded px-3 py-2 text-sm bg-white focus:border-orange-500 outline-none"
                        >
                ...
                <button 
                  onClick={addField} 
                  className="w-full py-4 border-2 border-dashed border-gray-300 rounded-lg text-gray-500 font-medium hover:border-orange-500 hover:text-orange-600 hover:bg-orange-50 transition-all flex items-center justify-center gap-2 mt-4"
                >
            ...
            <div className="mt-6 md:hidden">
              <button 
                onClick={handleSave} 
                className="w-full flex justify-center items-center gap-2 px-6 py-3 bg-orange-600 text-white rounded-lg shadow-lg font-bold"
              >
                <Save className="w-4 h-4" /> Save Form
              </button>
            </div>
