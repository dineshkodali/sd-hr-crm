  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-100 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
          {/* Search & Filter Bar */}
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {loading ? (
                    ...
                    filtered.map((row) => {
                      ...
                      return (
                        <tr key={row.id ?? row.reference} className={`hover:bg-gray-50/50 transition-colors border-b border-gray-100 last:border-0 group ${isDeleting ? 'inspection-deleting' : ''}`}>
                          {visibleColumns.checkbox && (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden flex-1">
                ...
                <div className="shrink-0 flex justify-end gap-3 p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                  ...
                  <button
                    type="button"
                    onClick={() => { setShowModal(false); setError(null); }}
                    className="px-6 py-2.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 font-medium transition-all text-sm shadow-sm hover:shadow"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-2.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 font-medium shadow-md transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
