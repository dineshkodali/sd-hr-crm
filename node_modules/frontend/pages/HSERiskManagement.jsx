        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-4">
                        <div className="w-full max-w-2xl rounded-xl bg-white shadow-2xl border border-gray-200 overflow-hidden">
                            ...
                            <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-gray-100 bg-gray-50">
                                <button
                                    onClick={closeExport}
                                    className="px-4 py-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-white border border-gray-200"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={runExport}
                                    className="px-4 py-2 rounded-xl text-sm font-medium text-white bg-teal-600 hover:bg-teal-700"
                                >
                                    Download
                                </button>
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div className="bg-white rounded-xl p-5 border border-gray-100 flex items-center gap-4 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5 hover:border-gray-300">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="relative" ref={viewRef}>
                                    <button
                                        ...
                                        className="bg-white border border-gray-300 text-gray-700 rounded-xl px-4 py-2 text-sm font-medium hover:bg-gray-50 transition-colors flex items-center gap-2"
                                    >
                                ...
                                {hasCreate && (
                                    <button
                                        onClick={() => openModal('create')}
                                        className="bg-teal-500 hover:bg-teal-600 text-white font-medium rounded-xl py-2.5 px-5 text-sm flex items-center gap-2 transition-all shadow-md "
                                    >
                                        <span>+</span>
                                        <span>New Risk Assessment</span>
                                    </button>
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {(priorityFilter || statusFilter || propertyFilter || sortBy) && (
                                <button
                                    ...
                                    className="text-sm text-teal-600 hover:text-teal-700 font-medium px-3 py-2 rounded-xl hover:bg-teal-50 transition-colors"
                                >
                                    Clear Filters
                                </button>
                            )}
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="bg-white">
                                    {loading ? (
                                        ...
                                        return (
                                            <tr key={idx} className={`hover:bg-gray-50/50 transition-colors ${isDeleting ? 'hse-risk-deleting' : ''}`}>
                                                {visibleColumns.checkbox && (
                                                        ...
                                                        <div className="flex items-center justify-center gap-1">
                                                            ...
                                                            {hasUpdate && (
                                                                <button
                                                                    ...
                                                                    className="p-1.5 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all"
                                                                    title="Edit"
                                                                >
                                                            ...
                                                            {hasDelete && (
                                                                <button
                                                                    ...
                                                                    className="p-1.5 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all"
                                                                    title="Delete"
                                                                >
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        statusItems.map((risk) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={risk.id}
                                                                    className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'hse-risk-card-deleting' : ''}`}
                                                ...
                                                <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-2">
                                                    ...
                                                    <div className="flex items-center gap-2 sm:shrink-0">
                                                        <button
                                                            ...
                                                            className="px-3 py-2.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 text-sm font-medium transition-colors whitespace-nowrap"
                                                        >
                                                            Add
                                                        </button>
                                                        <button
                                                            ...
                                                            className="px-3 py-2.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 text-sm font-medium transition-colors whitespace-nowrap"
                                                        >
                                                            Cancel
                                                        </button>
                                                    </div>
