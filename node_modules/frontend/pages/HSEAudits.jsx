                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="bg-white">
                                        {loading ? (
                                            ...
                                            return (
                                                <tr key={idx} className={`hover:bg-gray-50/50 transition-colors ${isDeleting ? 'hse-audit-deleting' : ''}`}>
                                                    {visibleColumns.checkbox && (
                                                        ...
                                                        {statusItems.length === 0 ? (
                                                            ...
                                                            statusItems.map((audit) => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={audit.id}
                                                                        className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'hse-audit-card-deleting' : ''}`}
