            ...
            <div>
                <div className="relative h-6 bg-slate-100 rounded-xl overflow-hidden">
                    {segments.map((s, i) => (
                        <div
                            key={i}
                            className="absolute top-0 h-6 rounded-xl"
    ...
    return (
        <div className="bg-white rounded-xl shadow">
            <div className="bg-slate-900 text-white rounded-t-md px-5 py-4 flex items-center gap-4">
                ...
                <button className="bg-slate-800/60 rounded-xl p-1 text-slate-200 text-sm">✎</button>
            </div>
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 text-xs text-slate-400">
                        <label className="inline-flex items-center gap-2">
                            <input type="checkbox" className="rounded-xl border-slate-300" /> Better than 85% of Employees
                        </label>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="bg-white rounded-xl shadow p-5">
            ...
            <div className="text-sm text-slate-700 space-y-3">
                ...
                <div className="mt-3">
                    <button className="w-full bg-slate-900 text-white py-2 rounded-xl ">Apply New Leave</button>
                </div>
            </div>
        </div>
    );
            ...
            <div className="space-y-3">
                {tasks.map((t) => (
                    <div key={t.id} className="flex items-center justify-between border rounded-xl p-3">
                        <div className="flex items-center gap-3">
                            <div className="w-6 h-6 rounded-xl border flex items-center justify-center text-slate-400 cursor-grab">⋮</div>
                            <input type="checkbox" className="rounded-xl form-checkbox h-4 w-4" checked={!!t.checked} readOnly />
                            <div className="ml-2">
    ...
    return (
        <div className="bg-white rounded-xl shadow p-4">
            <div className="flex items-center justify-between mb-3">
                ...
                <button className="text-xs bg-slate-100 px-3 py-1 rounded-xl ">View All</button>
            </div>
                        ...
                        <div className="flex-1">
                            ...
                            {n.actions && (
                                <div className="mt-2 flex gap-2">
                                    <button className="text-sm bg-orange-600 text-white px-3 py-1 rounded-xl ">Approve</button>
                                    <button className="text-sm border border-slate-300 px-3 py-1 rounded-xl ">Decline</button>
                                </div>
                            )}
                        </div>
                    </div>
                            ...
                            <div className="bg-[var(--bg-surface)] rounded-xl shadow-sm border-2 border-[var(--accent-shadow)] p-6 h-full flex flex-col justify-between">
                                <div>
                                    ...
                                    <div className="mt-6 text-center">
                                        <div className="inline-block bg-slate-900 text-white text-sm px-3 py-1 rounded-xl">Production : {attendance.production}</div>
                                    </div>
                                ...
                                <div className="mt-6">
                                    <button
                                        onClick={togglePunch}
                                        disabled={punchBusy}
                                        className="w-full px-6 py-3 rounded-xl bg-orange-600 text-white text-lg font-medium"
                                    >
