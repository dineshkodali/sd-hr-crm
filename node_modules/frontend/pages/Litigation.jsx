        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
                            ...
                            <div className="flex flex-wrap items-center gap-3 justify-start sm:justify-end">
                                ...
                                <div className="relative" ref={viewRef}>
                                    <button
                                        ...
                                        className="bg-white border border-gray-300 text-gray-700 rounded-xl px-4 py-2 text-sm font-medium hover:bg-gray-50 transition-all flex items-center gap-2"
                                    >
                                        ...
                                        <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                                            <div className="p-4 bg-gray-50 border-b border-gray-100">
                                                <div className="flex items-center justify-between mb-3">
                                                    ...
                                                    <button onClick={() => setShowViewMenu(false)} className="text-gray-400 hover:text-gray-600 rounded-xl">
                                                        <X className="w-4 h-4" />
                                                    </button>
                                                </div>
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold transition-all ${viewMode === 'table' ? 'bg-teal-500 text-white shadow-md' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-100'}`}
                                                    >
                                                        <Columns className="w-3.5 h-3.5" /> Table
                                                    </button>
                                                    <button
                                                        onClick={() => setViewMode('board')}
                                                        className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold transition-all ${viewMode === 'board' ? 'bg-teal-500 text-white shadow-md' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-100'}`}
                                                    >
                                ...
                                {hasCreate && (
                                    <button
                                        onClick={() => { setSelectedTask(null); setModalMode('create'); setShowModal(true); }}
                                        className="bg-teal-500 hover:bg-teal-600 text-white font-medium rounded-xl py-2 px-5 text-sm flex items-center gap-2 transition-all shadow-md "
                                    >
                                        <Gavel className="w-4 h-4" />
                        ...
                        <div className="flex items-center gap-4 py-4 px-6 bg-gray-50/50 border-y border-gray-100">
                            ...
                            {(filterPriority !== 'All Priority' || filterStatus !== 'All Status' || filterProperty !== 'All Properties' || sortBy) && (
                                <button
                                    ...
                                    className="text-sm text-red-600 hover:text-red-700 font-medium whitespace-nowrap px-2 flex items-center gap-1 rounded-xl"
                                >
                    ...
                    <div className="p-6">
                        {viewMode === 'table' ? (
                            <div className="overflow-x-auto scrollbar-hide rounded-xl border border-gray-200 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-300 relative">
                                <table className="w-full">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-100">
                                        {tasksLoading ? (
                                            ...
                                            return (
                                                <tr key={idx} className={`hover:bg-gray-50/50 transition-colors ${isDeleting ? 'litigation-deleting' : ''}`}>
                                                    {visibleColumns.checkbox && (
                                                        ...
                                                        {statusItems.length === 0 ? (
                                                            ...
                                                            statusItems.map((task) => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={task.id}
                                                                        className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'litigation-card-deleting' : ''}`}
                                                                        onClick={() => { setSelectedTask(task); setModalMode('view'); setShowModal(true); }}
                                                                    >
                            ...
                            {showCustomCategoryInput && (
                                <div className="mt-2 flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-1.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 text-sm font-medium"
                                    >
                                        Add
                                    </button>
                                    <button
                                        ...
                                        className="px-3 py-1.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 text-sm font-medium"
                                    >
                                        Cancel
                                    </button>
                                </div>
