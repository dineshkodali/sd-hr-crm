    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2.5 rounded-xl font-semibold shadow-sm flex items-center gap-2 transition-colors"
            >
                <Download size={18} />
                <span>Download</span>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-slate-100 py-1 z-20 animate-in fade-in zoom-in-95 duration-100">
                    <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-2 rounded-xl"
                    >
...
function StatCard({ colorBg, colorText, icon, title, value }) {
    return (
        <div className="bg-white rounded-xl p-5 flex items-center gap-4 flex-1 min-w-[240px] border border-gray-100 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
                ...
                <div className="flex flex-col md:flex-row items-center gap-3 mb-6">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <button
                            ...
                            className="h-9 bg-teal-500 hover:bg-teal-600 text-white px-4 rounded-xl font-semibold shadow-sm flex items-center gap-2 transition-colors text-xs whitespace-nowrap"
                        >
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        {filteredCertificates.map((c) => {
                                            ...
                                            return (
                                                <tr key={c.id} className={`hover:bg-slate-50/50 transition-colors group ${isDeleting ? 'compliance-deleting' : ''}`}>
                                                        ...
                                                        <div className="flex items-center justify-end gap-1 transition-opacity">
                                                            {hasDocument && (
                                                                <button
                                                                    ...
                                                                    className="p-1.5 text-slate-400 hover:text-teal-600 hover:bg-teal-50 rounded-xl transition-colors"
                                                                    title="View Document"
                                                                >
                                                            ...
                                                            <button
                                                                ...
                                                                className="p-1.5 text-slate-400 hover:text-orange-600 hover:bg-orange-50 rounded-xl transition-colors"
                                                                title="Edit"
                                                            >
                                ...
                                {viewMode ? (
                                    ...
                                    <form id="compliance-certificate-form" onSubmit={submitCertificate} className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                                                ...
                                                {showCustomCertificateTypeInput && (
                                                    <div className="mt-3 flex gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="px-4 py-2.5 rounded-xl -xl bg-teal-500 hover:bg-teal-600 text-white font-medium shadow-sm transition-colors"
                                                        >
                                                            Add
                                                        </button>
                                                        <button
                                        ...
                                        <div>
                                            ...
                                            <label className={`border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-center transition-all hover:border-emerald-400 hover:bg-emerald-50/30 cursor-pointer`}>
