        ...
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex items-center gap-4 transition-all hover:shadow-md hover:-translate-y-0.5">
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="bg-white">
                                    {loading ? (
                                        ...
                                        return (
                                            <tr key={row.id} className={`hover:bg-gray-50/50 transition-colors ${isDeleting ? 'emergency-protocol-deleting' : ''}`}>
                                                {visibleColumns.checkbox && (
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        statusItems.map((protocol) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={protocol.id}
                                                                    className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'emergency-protocol-card-deleting' : ''}`}
