...
export default function EmailNotifications({ user }) {
  ...
  const handleSaveTemplate = async () => {
    try {
      if (modalMode === 'create') {
        await axios.post('/api/email-notifications/templates', templateForm);
        showMessage('success', 'Template created successfully');
      } else {
        await axios.put(`/api/email-notifications/templates/${selectedTemplate.id}`, templateForm);
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm"
                />
              </div>
              ...
              <select
                ...
                className="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm bg-white"
              >
                  ...
                  <div className="space-y-4">
                    {filteredTemplates.length === 0 ? (
                      ...
                      filteredTemplates.map(template => (
                        <div key={template.id} className="bg-gray-50 rounded-xl p-5 hover:shadow-md transition-all border border-gray-200">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="10"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none font-mono text-sm"
                  placeholder="<html><body>Use {variable_name} for dynamic content</body></html>"
                />
              </div>
              <div>
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-teal-500 text-white font-medium rounded-lg hover:bg-teal-600 shadow-md hover:shadow-lg transition-all"
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-teal-500 text-white font-medium rounded-lg hover:bg-teal-600 shadow-md hover:shadow-lg transition-all flex items-center gap-2"
              >
                <Send className="w-4 h-4" />
                Send
              </button>
