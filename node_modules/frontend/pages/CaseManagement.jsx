        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div className="bg-white rounded-xl p-5 border border-gray-100 flex items-center gap-4 transition-all hover:shadow-md hover:-translate-y-0.5">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {(priorityFilter || statusFilter || propertyFilter || sortBy) && (
                                <button
                                    ...
                                    className="text-sm text-teal-600 hover:text-teal-700 font-medium px-3 py-1.5 hover:bg-teal-50 rounded-xl transition-colors"
                                >
                                    Clear Filters
                                </button>
                            )}
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="bg-white">
                                    {loading ? (
                                        ...
                                        return (
                                            <tr key={row.id} className={`hover:bg-gray-50/50 transition-colors ${isDeleting ? 'case-mgmt-deleting' : ''}`}>
                                                {/* Standard columns */}
                                                {visibleColumns.checkbox && (
                                                ...
                                                {visibleColumns.actions && (
                                                    <td className="py-5 px-6 text-center sticky right-0 z-10 bg-white" style={{ boxShadow: '-2px 0 5px -2px rgba(0,0,0,0.08)' }}>
                                                        <div className="flex items-center justify-center gap-1">
                                                            <button onClick={() => handleView(row)} className="p-1.5 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-xl transition-all" title="View">
                                                                <Eye className="w-4 h-4" />
                                                            </button>
                                                            {hasUpdate && (
                                                                <button onClick={() => handleEdit(row)} className="p-1.5 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all" title="Edit">
                                                                    <Edit className="w-4 h-4" />
                                                                </button>
                                                            )}
                                                            {hasDelete && (
                                                                <button onClick={() => handleDelete(row.id)} className="p-1.5 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all" title="Delete">
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        statusItems.map((caseItem) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={caseItem.id}
                                                                    className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'case-mgmt-card-deleting' : ''}`}
                        ...
                        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/60 backdrop-blur-md p-4 transition-opacity">
                            <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full h-[70vh] flex flex-col border border-gray-100 animate-in fade-in zoom-in duration-200">
                                ...
                                <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between z-10 flex-shrink-0">
                                    ...
                                    <button onClick={() => setShowView(false)} className="text-gray-400 hover:text-gray-600 transition-colors rounded-xl">
                                        <X className="w-5 h-5" />
                                    </button>
                                </div>
                                ...
                                <>
                                    ...
                                    <div className="flex justify-end gap-2 p-4 border-t border-gray-200">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 rounded-xl bg-teal-500 hover:bg-teal-600 text-white text-sm font-medium shadow-sm transition-colors flex items-center gap-2"
                                        >
                                            <Edit className="w-4 h-4" />
                                            Edit
                                        </button>
                            ...
                            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl relative h-[73vh] flex flex-col border border-gray-100">
                                                    ...
                                                    <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-2">
                                                        ...
                                                        <div className="flex items-center gap-2 sm:shrink-0">
                                                            <button
                                                                ...
                                                                className="px-3 py-2 bg-teal-500 text-white rounded-xl hover:bg-teal-600 text-sm font-medium whitespace-nowrap transition-colors"
                                                            >
                                                                Add
                                                            </button>
                                                            <button
                                                                ...
                                                                className="px-3 py-2 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 text-sm font-medium whitespace-nowrap transition-colors"
                                                            >
                                                                Cancel
                                                            </button>
                                                        </div>
                                ...
                                <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6 flex justify-end gap-3 flex-shrink-0 rounded-b-2xl">
                                    <button
                                        type="button"
                                        onClick={() => setShowForm(false)}
                                        className="px-5 py-2.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 font-medium transition-colors text-sm"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 font-medium shadow-sm transition-colors text-sm flex items-center gap-2"
                                    >
