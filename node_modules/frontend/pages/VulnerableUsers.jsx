                                                ...
                                                <div className="p-3 space-y-3 max-h-[calc(100vh-400px)] overflow-y-auto">
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        <div className="text-center py-8 px-4">
                                                            ...
                                                            <Users className="w-10 h-10 mx-auto mb-2 text-[var(--text-secondary)]" />

                                                            <p className="text-[var(--text-secondary)] text-sm">No users</p>
                                                        ...
                                                        statusItems.map((record) => {
                                                            ...
                                                            return (
                                                                ...
                                                                <div
                                                                    ...
                                                                    className={`bg-[var(--bg-surface)] rounded-xl p-4 shadow-sm border border-[var(--border-color)] transition-all cursor-pointer ${isDeleting ? 'vulnerable-users-card-deleting' : ''}`}
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex items-center justify-between mb-2">
                                                                        ...
                                                                        <span className="text-xs font-mono text-[var(--text-secondary)]">{record.reference || `VU-${record.id}`}</span>
