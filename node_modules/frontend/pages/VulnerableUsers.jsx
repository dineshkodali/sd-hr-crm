                            ...
                            <table className="w-full">
                                ...
                                <tbody className="bg-white">
                                    {recordsLoading ? (
                                        ...
                                        return (
                                            <tr key={idx} className={`hover:bg-teal-50/30 transition-all ${isDeleting ? 'vulnerable-users-deleting' : ''}`}>
                                                {visibleColumns.checkbox && (
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        statusItems.map((record) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={record.id}
                                                                    className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'vulnerable-users-card-deleting' : ''}`}
