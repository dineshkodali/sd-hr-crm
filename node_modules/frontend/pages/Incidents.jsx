    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
                    {/* Search & Filter Bar */}
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="relative" ref={viewRef}>
                                        <button
                                            ...
                                            className="h-9 bg-white border border-gray-300 text-gray-700 rounded-xl px-3 text-xs font-medium hover:bg-gray-50 flex items-center gap-2"
                                        >
                                    ...
                                    {hasCreate && (
                                        <button
                                            ...
                                            className="h-9 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-xl px-4 text-xs flex items-center gap-2 shadow-sm"
                                        >
                                            <ClipboardList className="w-4 h-4" />
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {(severityFilter || statusFilter || propertyFilter || sortBy) && (
                                    <button
                                        ...
                                        className="bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl px-4 py-2 text-sm font-medium flex items-center gap-2"
                                    >
                                        <X className="w-4 h-4" />
                                        <span>Clear</span>
                                    </button>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="bg-white divide-y divide-gray-100">
                                    {loading ? (
                                        ...
                                        return (
                                            <tr key={row.ref} className={`hover:bg-gray-50/50 transition-colors border-b border-gray-100 last:border-0 ${isDeleting ? 'incident-deleting' : ''}`}>
                                                {/* Removed duplicate manual checkbox block */}
                                                {ALL_COLUMNS.map(col => (
                                                    visibleColumns[col] && (
                                                        <td key={col} className={`py-4 px-4 ${col === 'date' || col === 'reference' ? 'whitespace-nowrap' : ''} ${col === 'actions' ? 'text-center sticky right-0 z-10 bg-white' : ''}`} style={col === 'actions' ? { boxShadow: '-2px 0 5px -2px rgba(0,0,0,0.08)' } : undefined}>
                                                            {(() => {
                                                                ...
                                                                if (col === 'actions') return <div className="flex items-center justify-center gap-1"><button onClick={() => handleView(row)} className="p-1.5 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-xl transition-all" title="View"><Eye className="w-4 h-4" /></button>{hasUpdate && (<button onClick={() => handleEdit(row)} className="p-1.5 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all" title="Edit"><Edit className="w-4 h-4" /></button>)}{hasDelete && (<button onClick={() => handleDelete(row)} className="p-1.5 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all" title="Delete"><Trash2 className="w-4 h-4" /></button>)}</div>;
                                                    ...
                                                    {statusItems.length === 0 ? (
                                                        ...
                                                        statusItems.map((row) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={row.ref}
                                                                    className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'incident-card-deleting' : ''}`}
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
                                        ...
                                        {showCustomIncidentTypeInput && (
                                            <div className="mt-2 flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-2.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 text-sm font-medium transition-colors"
                                                >
                                                    Add
                                                </button>
                                                <button
                                                    ...
                                                    className="px-3 py-2.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 text-sm font-medium transition-colors"
                                                >
                                                    Cancel
                                                </button>
                                            </div>
                            ...
                            <div className="shrink-0 flex justify-end gap-3 p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                                <button
                                    ...
                                    className="px-4 py-1.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 font-medium transition-colors text-sm"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="px-4 py-1.5 bg-teal-500 text-white rounded-xl hover:bg-teal-600 font-medium shadow-sm transition-colors text-sm"
                                >
