              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 rounded-xl"
          ...
          <div className="mb-6 flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2.5 text-gray-500 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
                title="Clear Filters"
              >
                <X className="w-4 h-4" />
              </button>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {loading ? (
                  ...
                  return (
                    <tr key={u.id || index} className={`border-b border-gray-100 hover:bg-teal-50/50 transition-colors ${isDeleting ? 'admin-user-deleting' : ''}`}>
                      ...
                      <td className="p-4 sticky right-0 z-10 bg-white" style={{ boxShadow: '-2px 0 5px -2px rgba(0,0,0,0.08)' }}>
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <button
                            ...
                            title="Delete user"
                            className="btn-secondary btn-sm w-10 !px-0 hover:!text-red-600 hover:!bg-red-50 hover:!border-red-200 rounded-xl"
                          >
          ...
          {filteredUsers.length > 0 && (
            <div className="mt-6 flex items-center justify-between border-t border-gray-200 pt-4">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-2 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                  Previous
                </button>
                <button className="px-3 py-2 bg-teal-500 text-white rounded-xl text-sm font-medium hover:bg-teal-600">
                  1
                </button>
                <button className="px-3 py-2 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50">
                  Next
                </button>
              </div>
            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
              <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-gray-50">
                ...
                <button onClick={closeEdit} className="rounded-xl text-gray-400 hover:text-gray-600 transition-colors">
              ...
              <div className="p-6 overflow-y-auto">
                <form onSubmit={saveEdit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    <button type="button" onClick={closeEdit} className="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-50 transition-colors">Cancel</button>
                    <button type="submit" disabled={saving} className="px-5 py-2.5 rounded-xl bg-teal-400 hover:bg-teal-500 active:bg-teal-600 text-white text-sm font-medium transition-all disabled:opacity-50">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
              <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-blue-50">
                ...
                <button onClick={closeMoveRoom} className="rounded-xl text-gray-400 hover:text-gray-600 transition-colors">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                </button>
              </div>
                ...
                <form onSubmit={handleMoveRoomSubmit} className="space-y-5">
                  ...
                  <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      {movingRoom ? (
                        <>
