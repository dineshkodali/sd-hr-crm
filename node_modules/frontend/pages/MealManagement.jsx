                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-4">
                        <div className="w-full max-w-2xl rounded-xl bg-white shadow-2xl border border-gray-200 overflow-hidden">
                            ...
                            <div className="px-5 py-4 border-t border-gray-100 flex justify-end gap-3">
                                ...
                                <button
                                    onClick={runExport}
                                    className="px-4 py-2 text-sm font-medium text-white bg-teal-500 rounded-xl hover:bg-teal-600 transition-colors"
                                >
                                    Download
                                </button>
                            </div>
                                        ...
                                        <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 z-50">
                                            <div className="p-4">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full flex items-center justify-between px-2 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-xl transition-colors"
                                                >
                                                        ...
                                                        <div className="flex items-center justify-between mb-2">
                                                            ...
                                                            <div className="text-xs font-medium">
                                                                <button
                                                                    ...
                                                                    className="text-teal-600 hover:text-teal-700 rounded-xl"
                                                                    type="button"
                                                                >
                                                                    Show all
                                                                </button>
                                                            ...
                                                            {ALL_COLUMNS.map((col) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className="w-full flex items-center justify-between px-3 py-2 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-colors"
                                                                    >
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {(filterMealType !== 'All Meals' || filterStatus !== 'All Status' || selectedProperty || sortBy) && (
                                <button
                                    ...
                                    className="bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl px-4 py-2 text-sm font-medium transition-all flex items-center gap-2"
                                >
                                    <X className="w-4 h-4" />
                                    <span>Clear</span>
                                </button>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    filteredMeals().map((m) => {
                                        ...
                                        <tr
                                            key={m.id}
                                            className={`hover:bg-gray-50 transition-colors ${isDeleting ? 'meal-deleting' : ''}`}
                                        >
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <div className="flex items-center justify-center gap-1.5">
                                                        <button
                                                            ...
                                                            className="group relative p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50/50 rounded-xl hover:shadow-sm"
                                                        >
                                                            <IconEye />
                                                        </button>
                                                        {canUpdatePage && (
                                                            <button
                                                                ...
                                                                className="group relative p-2 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50/50 rounded-xl hover:shadow-sm"
                                                            >
                                                                <IconEdit />
                                                            </button>
                                                        )}
                                                        {canDeletePage && (
                                                            <button
                                                                ...
                                                                className="group relative p-2 text-gray-400 hover:text-rose-600 hover:bg-rose-50/50 rounded-xl hover:shadow-sm"
                                                            >
                                                                <IconTrash />
                                                            </button>
                                                        )}
                                                        ...
                                                        {canUpdatePage && (
                                                            String(m.status).toLowerCase() === "consumed" ? (
                                                                <button
                                                                    ...
                                                                    className="ml-1 px-3 py-1.5 rounded-xl bg-amber-500/10 hover:bg-amber-500 text-amber-700 hover:text-white text-xs font-medium border border-amber-200 hover:border-amber-500"
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="ml-1 px-3 py-1.5 rounded-xl bg-teal-500/10 hover:bg-teal-500 text-teal-700 hover:text-white text-xs font-medium border border-teal-200 hover:border-teal-500"
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/60 backdrop-blur-md p-4 transition-opacity">
            <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full h-[70vh] flex flex-col border border-gray-100 animate-in fade-in zoom-in duration-200">
                <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between z-10 flex-shrink-0">
                    ...
                    <button onClick={onClose} className="text-gray-400 hover:text-gray-600 transition-colors rounded-xl p-2 hover:bg-slate-100">
                        <X className="w-5 h-5" />
                    </button>
                </div>
