...
const ALL_MODULES = [
  ...
  { key: "tickets", label: "Tickets", category: "Support" },
  { key: "tasks", label: "Tasks", category: "Support" },
  { key: "hr_management", label: "HR Management", category: "HR" },
  { key: "holidays", label: "Holidays", category: "HR" },
  { key: "attendance", label: "Attendance", category: "HR" },
  { key: "timesheets", label: "Timesheets", category: "HR" },
  { key: "performance", label: "Performance", category: "HR" },
  { key: "training", label: "Training", category: "HR" },
  { key: "payroll", label: "Payroll", category: "HR" },
  { key: "overtime", label: "Overtime", category: "HR" },
              ...
              <div>
                ...
                <div className="mb-6 flex gap-4 border-b border-gray-100 pb-4">
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeSubTab === "users" ? "bg-teal-50 text-teal-600" : "text-gray-600 hover:bg-gray-50"}`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeSubTab === "roles" ? "bg-teal-50 text-teal-600" : "text-gray-600 hover:bg-gray-50"}`}
                  >
                  ...
                  <div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <button
                        ...
                        className="bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600 transition-colors shadow-md hover:shadow-lg flex items-center gap-2"
                      >
                    ...
                    {loading ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {groups.map((group) => (
                          <div key={group.id} className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg transition-shadow">
                            ...
                            <button
                              ...
                              className="w-full py-2 text-sm font-medium text-teal-600 bg-teal-50 rounded-lg hover:bg-teal-100 transition-colors"
                            >
                              Manage Group
                            </button>
                          </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <div className="flex justify-between items-center mb-4">
                          ...
                          <button
                            ...
                            className="text-sm px-3 py-1.5 bg-teal-500 text-white rounded-lg hover:bg-teal-600 flex items-center gap-1"
                          >
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="space-y-3 max-h-96 overflow-y-auto">
                          {filteredModules.map((module) => {
                            ...
                            return (
                              <div key={module.key} className="p-3 bg-gray-50 rounded-lg">
                        ...
                        <button
                          ...
                          disabled={saving}
                          className="w-full mt-4 py-2 text-sm font-medium text-white bg-teal-500 rounded-lg hover:bg-teal-600 disabled:opacity-50"
                        >
