    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            <div className="p-3 sm:p-4 md:p-6 w-[90%] max-w-[1800px] mx-auto">
                ...
                <div className="bg-white rounded-xl border border-gray-100 mt-6 shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
                                ...
                                <div className="flex flex-wrap items-center gap-3 justify-start sm:justify-end">
                                    ...
                                    {hasCreate && (
                                        <button
                                            ...
                                            className="h-9 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-xl px-4 text-xs flex items-center gap-2 shadow-sm transition-colors"
                                        >
                                            <ClipboardList className="w-4 h-4" />
                            ...
                            <div className="flex items-center flex-wrap gap-3 py-3 border-t border-gray-50">
                                ...
                                {(priorityFilter || statusFilter || propertyFilter || sortBy) && (
                                    <button
                                        ...
                                        className="h-9 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl px-4 text-xs font-medium transition-all flex items-center gap-2"
                                    >
                                        <X className="w-4 h-4" />
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-100">
                                        {loading ? (
                                            ...
                                            return (
                                                <tr key={row.id} className={`hover:bg-gray-50/50 transition-colors border-b border-gray-100 last:border-0 ${isDeleting ? 'complaint-deleting' : ''}`}>
                                                    {visibleColumns.checkbox && (
                                                        ...
                                                        {statusItems.length === 0 ? (
                                                            ...
                                                            statusItems.map((complaint) => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={complaint.id}
                                                                        className={`bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all cursor-pointer ${isDeleting ? 'complaint-card-deleting' : ''}`}
                            ...
                            <div className="modal-container h-[70vh]">
                                            ...
                                            {showCustomCategoryInput && (
                                                <div className="mt-3 flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-5 py-3 bg-teal-500 text-white rounded-xl -xl hover:bg-teal-600 text-sm font-semibold transition-all shadow-md active:scale-95"
                                                    >
                                                        Add
                                                    </button>
                                                    <button
                                                        ...
                                                        className="px-5 py-3 border border-gray-200 rounded-xl text-gray-700 hover:bg-gray-50 text-sm font-semibold transition-all"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
                                ...
                                <div className="modal-footer px-8 py-6 bg-gray-50 rounded-b-2xl border-t border-gray-100 flex justify-end gap-3">
                                    <button
                                        type="button"
                                        onClick={() => setShowForm(false)}
                                        className="px-6 py-2.5 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-100 text-sm font-semibold transition-all shadow-sm active:scale-95"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        type="submit"
                                        form="complaint-form"
                                        className="px-10 py-2.5 bg-teal-500 text-white rounded-xl -xl hover:bg-teal-600 text-sm font-bold transition-all shadow-md active:scale-95 flex items-center gap-2"
                                    >
