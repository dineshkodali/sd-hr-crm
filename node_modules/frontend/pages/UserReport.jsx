...
export default function UserReport() {
 ...
 <button onClick={exportCSV} className="px-4 py-2 border rounded-xl bg-white">Export</button>
 <button className="px-3 py-2 border rounded-xl bg-white">↑</button>
 </div>
 </div>
 </header>
 ...
 <div>
 <select className="px-3 py-2 border rounded-xl bg-white text-sm">
 ...
 <input type="text" value={dateRange} onChange={(e) => setDateRange(e.target.value)} className="ml-2 px-3 py-2 border rounded-xl" placeholder="11/13/2025 - 11/19/2025" />
 </div>

 <div>
 <label className="text-xs text-gray-400">Role</label>
 <select value={roleFilter} onChange={(e) => setRoleFilter(e.target.value)} className="ml-2 px-3 py-2 border rounded-xl">
 ...
 <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className="ml-2 px-3 py-2 border rounded-xl">
 <option value="">All</option>
 ...
 <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="ml-2 px-3 py-2 border rounded-xl">
 ...
 <select value={limit} onChange={(e) => { setLimit(Number(e.target.value)); setOffset(0); }} className="px-3 py-2 border rounded-xl">
 ...
 <div>
 <input placeholder="Search" value={search} onChange={(e) => setSearch(e.target.value)} className="px-3 py-2 border rounded-xl" />
 </div>
 </div>
 </div>
 </section>
 ...
 <div className="flex items-center gap-3">
 <button onClick={() => setOffset(Math.max(0, offset - limit))} className="px-3 py-1 border rounded-xl">Prev</button>
 <button onClick={() => setOffset(Math.min(Math.max(0, filtered.length - limit), offset + limit))} className="px-3 py-1 border rounded-xl">Next</button>
 </div>
 </div>
 </section>
 </div>
