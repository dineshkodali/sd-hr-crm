                                ...
                                <div className="divide-y divide-gray-100">
                                    {users.map((user) => (
                                        <button
                                            ...
                                            className={`w-full text-left p-4 hover:bg-gray-50 transition-colors ${selectedUser?.id === user.id ? "bg-orange-50 border-l-4 border-orange-500" : ""
                                                }`}
                                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-4 max-h-[500px] overflow-y-auto">
                                    {MODULES.map((module) => {
                                        ...
                                        return (
                                            <div key={module.key} className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    <label className="flex items-center cursor-pointer">
                                                        <input
                                                            ...
                                                            className="form-checkbox h-4 w-4 text-orange-600 border-gray-300 rounded-xl"
                                                        />
                            ...
                            <div className="p-6 border-t border-gray-200">
                                <div className="flex justify-end gap-4">
                                    ...
                                    <button
                                        ...
                                        disabled={saving}
                                        className={`px-4 py-2 text-sm font-semibold rounded-xl transition-all flex items-center justify-center gap-2 ${saving ? "bg-orange-600 text-white cursor-not-allowed" : "bg-orange-500 text-white hover:bg-orange-600"
                                            }`}
                                    >
                                        {saving && (
