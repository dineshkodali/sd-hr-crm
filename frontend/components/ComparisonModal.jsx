  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* Modal panel */}
        <div className="inline-block w-full max-w-6xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-xl">
          {/* Header */}
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                ...
                {log.resource && (
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 bg-gray-100 rounded-xl text-xs font-medium">
                      {log.resource}
                    </span>
                  </div>
                )}
              ...
              {log.description && (
                <p className="mt-3 text-gray-700 bg-gray-50 p-3 rounded-xl">
                  {log.description}
                </p>
              )}
            </div>
            ...
            <button
              onClick={onClose}
              className="ml-4 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
