      ...
      <aside className="relative ml-auto w-full max-w-2xl bg-white shadow-xl overflow-auto">
        <div className="flex items-center justify-between p-4 border-b">
          ...
          <div className="flex items-center gap-3">
            <a href={resumeUrl || "#"} target="_blank" rel="noreferrer" className={`inline-flex items-center gap-2 px-3 py-1 rounded-xl ${resumeUrl ? "bg-slate-50 text-slate-700" : "bg-gray-100 text-gray-400 cursor-not-allowed"}`}>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-white border rounded-xl">
            ...
            <div className="p-4 flex items-center justify-between">
              ...
              {resumeUrl ? (
                <a href={resumeUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-indigo-600 text-white">
                  Download
                </a>
              ) : null}
            </div>
