...
export default function FormView(props) {
 ...
 <button onClick={() => navigate(`${prefix}/forms`)} className="px-4 py-2 bg-gray-200 rounded-xl">
 Back to Forms
 </button>
 </div>
 );
 ...
 {field.required && (
 <span className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded-xl">
 Required
 </span>
 )}
 </div>
