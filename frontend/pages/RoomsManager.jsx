 ...
 */}
 <div className="h-screen overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100 font-sans pb-24" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
 ...
 type="button"
 onClick={goBack}
 className="group flex items-center gap-2 text-sm font-semibold text-slate-600 bg-white border border-slate-200 px-3 py-1.5 rounded-xl shadow-sm hover:border-teal-500 hover:text-teal-600 "
 >
 ...
 {loading ? (
 <div className="bg-white rounded-xl shadow-sm border border-[#d3f1ec] p-16 text-center">
 ...
 {/* Create / Edit Form */}
 <div className="bg-white rounded-xl shadow-sm border border-[#d3f1ec] p-6 sm:p-8">
 ...
 required
 className="w-full h-[2.25rem] px-4 bg-[#f0faf9] border border-[#d3f1ec] rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-[#d3f1ec] text-slate-700 placeholder-slate-400 transition-all outline-none"
 />
 </div>
 ...
 className="w-full h-[2.25rem] px-4 bg-[#f0faf9] border border-[#d3f1ec] rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-[#d3f1ec] text-slate-700 transition-all outline-none py-0"
 >
 ...
 disabled
 className="w-full h-[2.25rem] px-4 bg-[#f0faf9] border border-[#d3f1ec] rounded-xl -xl text-slate-700 transition-all outline-none opacity-70 cursor-not-allowed py-0"
 >
 ...
 placeholder="Select..."
 className="w-full h-[2.25rem] px-4 bg-[#f0faf9] border border-[#d3f1ec] rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-[#d3f1ec] text-slate-700 placeholder-slate-400 transition-all outline-none cursor-pointer"
 />
 ...
 const isCustom = (customDropdownOptions[col.column_name] || []).includes(v);
 return (
 <div key={`${v}-${i}`} className="group w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-teal-50 transition-colors">
 <button
 type="button"
 onClick={() => {
 ...
 checked={checked}
 readOnly
 className="rounded-xl h-4 w-4 accent-teal-600"
 />
 ...
 type="button"
 onClick={() => {
 const nextOpts = (customDropdownOptions[col.column_name] || []).filter(o => o !== v);
 const nextCustom = { ...customDropdownOptions, [col.column_name]: nextOpts };
 setCustomDropdownOptions(nextCustom);
 const key = `roomsManager.customOptions.${String(col.column_name)}`;
 localStorage.setItem(key, JSON.stringify(nextOpts));
 }}
 ...
 className="flex-1 h-[2.25rem] px-3 bg-white border border-[#d3f1ec] rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-[#d3f1ec] text-slate-700 placeholder-slate-400 transition-all outline-none"
 />
 <button
 type="button"
 onClick={() => {
 ...
 className="btn-primary h-[2.25rem] px-4 rounded-xl"
 >
 Add
 </button>
 </div>
 ...
 className="text-teal-700/70 hover:text-teal-900 rounded-xl"
 aria-label="Remove"
 >
 ×
 </button>
 ...
 className="h-5 w-5 accent-teal-600 rounded-xl"
 />
 ...
 <button
 type="submit"
 className="rounded-xl flex-1 btn-primary justify-center h-[3rem]"
 ...
 <span>{editing ? "Save Changes" : "Create Room"}</span>
 </>
 )}
 </button>
 ...
 {!canManage && (
 <div className="md:col-span-3 flex items-center gap-3 text-sm bg-orange-50 border border-orange-100 rounded-xl px-4 py-3 text-orange-800">
 ...
 {rooms.length === 0 ? (
 <div className="text-center py-16 bg-[#f0faf9] rounded-xl border border-dashed border-[#d3f1ec]">
 ...
 className="group bg-white rounded-xl border border-[#d3f1ec] p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:border-teal-200 cursor-pointer"
 >
 <div className="flex items-start justify-between mb-4">
 <div className="flex items-center gap-3">
 <div className="w-12 h-12 rounded-xl bg-[#f0faf9] border border-[#d3f1ec] flex items-center justify-center text-teal-800 font-bold text-lg">
 {r.room_number}
 </div>
 <div>
 ...
 className="flex items-center justify-center gap-2 px-3 py-2 bg-rose-50 border border-rose-100 hover:bg-rose-100 text-rose-600 rounded-xl font-semibold text-sm transition-all h-[1.75rem]"
 >
 <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
 </svg>
 ...
 <div className="pt-3 border border-slate-100 text-center mt-3">
