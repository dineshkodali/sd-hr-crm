              ...
              <div className="p-6 border-t border-gray-200">
                <div className="flex justify-end gap-4">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all flex items-center justify-center gap-2 ${saving ? "bg-orange-600 text-white cursor-not-allowed" : "bg-orange-500 text-white hover:bg-orange-600"
                      }`}
                  >
                    {saving && (
