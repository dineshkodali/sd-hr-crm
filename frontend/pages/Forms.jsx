...
export default function Forms({ user }) {
 ...
 className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/30 focus:border-[#2de8c8] transition-all"
 />
 </div>
 </div>
 ...
 <button
 onClick={fetchTables}
 className="p-1 hover:bg-gray-100 rounded-xl text-gray-400 hover:text-gray-600 transition-colors"
 ...
 <div className="w-10 h-10 bg-[#2de8c8]/10 rounded-xl flex items-center justify-center text-[#2de8c8]">
 ...
 className="bg-[#2de8c8] hover:bg-[#25c2a7] text-white px-4 py-2.5 rounded-xl text-sm font-medium flex items-center gap-2 shadow-sm transition-all active:scale-95"
 >
 ...
 {[1, 2, 3].map(i => <div key={i} className="h-12 bg-white rounded-xl shadow-sm border border-gray-100 animate-pulse"></div>)}
 </div>
 ) : columns.length === 0 ? (
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/20 focus:border-[#2de8c8] text-sm text-gray-700 placeholder-gray-400 transition-all"
 />
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/20 focus:border-[#2de8c8] text-sm text-gray-700 bg-white transition-all"
 >
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/20 focus:border-[#2de8c8] text-sm text-gray-700 bg-white transition-all hover:bg-blue-50/50"
 >
 <option value="text">text</option>
 ...
 className="text-xs font-medium text-[#2de8c8] hover:text-[#25c2a7] bg-[#2de8c8]/10 hover:bg-[#2de8c8]/20 px-3 py-1.5 rounded-xl transition-colors"
 >
 + Add Option
 </button>
 </div>
 ...
 className="flex-1 px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/20 focus:border-[#2de8c8] text-sm text-gray-700 transition-all"
 />
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2de8c8]/20 focus:border-[#2de8c8] text-sm text-gray-700 transition-all"
 />
 </div>
 )}
 ...
 <div className={`w-5 h-5 rounded-xl border flex items-center justify-center transition-colors ${!newColumn.nullable ? 'bg-[#2de8c8] border-[#2de8c8]' : 'bg-white border-gray-300 group-hover:border-[#2de8c8]'}`}>
 ...
 <label className="flex items-center gap-3 cursor-pointer group">
 <div className={`w-5 h-5 rounded-xl border flex items-center justify-center transition-colors ${newColumn.unique ? 'bg-[#2de8c8] border-[#2de8c8]' : 'bg-white border-gray-300 group-hover:border-[#2de8c8]'}`}>
 ...
 className="px-5 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-colors border border-gray-200"
 >
 Cancel
 </button>
 <button
 onClick={handleAddColumn}
 className="px-5 py-2.5 text-sm font-medium text-white bg-[#2de8c8] hover:bg-[#25c2a7] rounded-xl shadow-lg shadow-[#2de8c8]/30 transition-all active:scale-95"
 >
 Add Column
 </button>
 </div>
 ...
 <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-shrink-0">
 <div>
 <h3 className="font-bold text-lg text-gray-800">Edit Column</h3>
 ...
 <div className="space-y-3 pt-2">
 <label className="flex items-center gap-3 cursor-pointer group">
 <div className={`w-5 h-5 rounded-xl border flex items-center justify-center transition-colors ${!editingColumn.nullable ? 'bg-[#2de8c8] border-[#2de8c8]' : 'bg-white border-gray-300 group-hover:border-[#2de8c8]'}`}>
 ...
 <label className="flex items-center gap-3 cursor-pointer group">
 <div className={`w-5 h-5 rounded-xl border flex items-center justify-center transition-colors ${editingColumn.unique ? 'bg-[#2de8c8] border-[#2de8c8]' : 'bg-white border-gray-300 group-hover:border-[#2de8c8]'}`}>
 ...
 className="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-medium hover:bg-gray-100 transition-colors disabled:opacity-60"
 >
 Cancel
 </button>
 <button
 ...
 className="px-5 py-2.5 rounded-xl font-medium shadow-sm hover:shadow bg-rose-500 hover:bg-rose-600 text-white disabled:opacity-60"
 >
