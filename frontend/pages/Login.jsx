...
const Login = ({ setUser }) => {
  ...
  const handleRequestOTP = async () => {
    ...
    setLoading(true);
    try {
      await axios.post("/api/auth/request-login-otp", { email: form.email }, { withCredentials: true });
      setOtpSent(true);
  ...
  // Live stats for right panel (properties, service users, compliance, safeguarding)
  ...
  useEffect(() => {
    ...
    async function fetchStats() {
      try {
        const summaryRes = await axios.get('/api/dashboard/public-summary').catch(() => null);
        ...
        // summaryRes already contains lightweight counts for properties, serviceUsers, compliance, safeguarding
  ...
  // ==========================================
  // UI SECTION (MATCHING SCREENSHOT)
  // ==========================================
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 font-sans text-slate-800">
      <div className="w-full max-w-[1100px] h-[735px] bg-white rounded-[30px] shadow-2xl overflow-hidden flex flex-col lg:flex-row">
                  ...
                  <form onSubmit={handleResetPassword} className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500 ml-1 mt-1">
                        Minimum 6 characters. Cannot be a previously used password.
                      </p>
                    </div>
                    <div className="space-y-1">
        ...
        {/* RIGHT SIDE: Info Panel (Teal Background) */}
        <div className="hidden lg:flex w-full lg:w-[60%] bg-[#409187] relative flex-col justify-center p-12 text-white">
          ...
          <div className="relative z-10 max-w-lg mx-auto">
            ...
            {/* 4-Grid Layout (Matches Screenshot) */}
