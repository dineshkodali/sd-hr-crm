            ...
            <div className="p-3 sm:p-4 md:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 mt-4">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-gray-100 flex items-center gap-4 transition-all duration-200">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Open</div>
                    ...
                    <div className="p-6 pb-0">
                        <div className="mb-6">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <h2 className="text-lg font-semibold text-slate-900 mb-1">Incidents Directory</h2>
                                    ...
                                    <tr className="border-b border-gray-100">
                                        {ALL_COLUMNS.map(col => (
                                            visibleColumns[col] && (
                                                <th
                                                    key={col}
                                                    className={`${col === 'actions' ? 'text-center sticky right-0 z-10 bg-gray-50' : 'text-left'} py-4 px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider`}
