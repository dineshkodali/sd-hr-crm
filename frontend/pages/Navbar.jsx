...
export default function Navbar({ user, setUser, children }) {
 ...
 {/* <button
 onClick={goToPanel}
 className="px-4 py-2 rounded-xl bg-[#00ffd9] text-white text-sm font-medium hover:bg-[#00e6c3] transition-colors shadow-sm shadow-cyan-100"
 >
 {getPanelText()}
 </button> */}
 ...
 <button
 onClick={logout}
 className="px-4 py-2 rounded-xl border border-red-100 bg-red-50 text-red-600 text-sm font-medium hover:bg-red-100 transition-colors"
 >
 Logout
 </button>
 ...
 <span className="font-medium bg-gray-100 px-2 py-0.5 rounded-xl text-xs uppercase tracking-wide">{localUser.role}</span>
 </div>
 {localUser.branch && (
 <div className="flex justify-between">
 ...
 className="flex-1 px-3 py-2 rounded-xl bg-gray-100 text-gray-700 text-sm font-medium hover:bg-gray-200 transition-colors"
 >
 Home
 </button>
 <button
 onClick={() => { setOpen(false); logout(); }}
 className="flex-1 px-3 py-2 rounded-xl bg-red-50 text-red-600 text-sm font-medium hover:bg-red-100 transition-colors"
 >
 Logout
 </button>
 </div>
 ...
 className="px-5 py-2 rounded-xl bg-[#00ffd9] text-white font-medium hover:bg-[#00e6c3] transition-colors shadow-sm"
 >
 Login
 </button>
 )}
