      ...
      <div className="p-3 sm:p-4 md:p-6">
        ...
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <h1 className="text-3xl font-black text-slate-900 mt-1">Inspections Dashboard</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 mt-4">
          <div className="bg-white rounded-xl p-5 border border-gray-100 flex items-center gap-4 transition-all duration-200">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Total Inspections</div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 transition-all duration-200">
          {/* Search & Filter Bar */}
          <div className="p-6 pb-0">
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-lg font-semibold text-slate-900 mb-1">Inspections Directory</h2>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-9 bg-white border border-gray-300 rounded-xl pl-10 pr-4 text-xs focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 w-64"
                    />
                  </div>
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {loading ? (
                    ...
                    filtered.map((row) => {
                      ...
                      return (
                        <tr key={row.id ?? row.reference} className={`transition-colors border-b border-gray-100 last:border-0 group ${isDeleting ? 'inspection-deleting' : ''}`}>
                          {visibleColumns.checkbox && (
                          ...
                          {visibleColumns.description && (
                            <td className="py-4 px-4">
                              <div>
                                <div className={`text-gray-900 font-medium ${hasUpdate ? 'cursor-pointer' : ''} transition-colors flex items-center gap-2`}
                                  onClick={hasUpdate ? () => handleEdit(row.id) : undefined}>
                                  <Building className="w-4 h-4 text-gray-400" />
                                  <span className="font-semibold text-slate-800">{row.propertyName || row.property_name || "Unknown Property"}</span>
                                </div>
                          ...
                          {statusItems.length === 0 ? (
                            ...
                            statusItems.map((insp) => {
                              ...
                              return (
                                <div
                                  key={insp.id}
                                  className={`bg-white rounded-xl p-4 shadow-sm border border-gray-100 ${deletingIds.has(insp.id) ? 'inspection-card-deleting' : ''}`}
                                ...
                                >
                                  ...
                                  {insp.issuesFound > 0 && (
                                    <div className="mb-3">
                                      <span className="inline-flex items-center gap-1 px-2 py-1 bg-red-50 text-red-600 rounded-xl text-xs font-medium">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden flex-1">
                <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1">
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Issues Found <span className="text-red-500">*</span></label>
                      <input
                        type="number"
                        name="issuesFound"
                        required
                    ...
                    <div className="col-span-1">
                      <label className="block text-sm font-semibold text-slate-700 mb-2">Action Required <span className="text-red-500">*</span></label>
                      <select
                        name="actionRequired"
                        required
