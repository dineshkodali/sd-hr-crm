...
export default function PPARFileUpload() {
  ...
  const handleFileUpload = async (file) => {
    ...
    try {
      ...
      // Send to API
      const response = await api.post('/api/hotels/' + formData.propertyId + '/import-rooms', {
        rooms: roomsData,
        property_id: formData.propertyId,
      });
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
          ...
          <div className="mt-6">
            ...
            <select 
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:border-teal-200 focus:ring-2 focus:ring-teal-300"
            >
          ...
          <div className="mt-6">
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 bg-slate-50/50 hover:bg-slate-50 transition-colors">
              <input
                type="file"
                id="ppar-file"
                accept=".xlsx,.xls,.csv"
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium py-2.5 rounded-lg flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="flex-1 bg-teal-500 hover:bg-teal-600 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-medium py-2.5 rounded-lg flex items-center justify-center gap-2 transition-colors"
            >
              {uploading ? (
                <>
