...
export default function OrganizationChart({ user }) {
 ...
 <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100 transition-all">
 ...
 className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm"
 />
 </div>
 ...
 className="px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm bg-white"
 >
 ...
 <div className="bg-gradient-to-r from-teal-500 to-blue-500 rounded-xl p-4 shadow-lg transition-all">
 <div className="flex items-center gap-4">
 {/* Expand/Collapse Button */}
 <button
 onClick={() => toggleBranch(branch.id)}
 className="bg-white/20 hover:bg-white/30 p-2 rounded-xl transition-colors flex-shrink-0"
 >
 {isExpanded ? (
 ...
 <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-3 inline-flex items-center gap-3 shadow-sm transition-all">
 ...
 {/* Employee Card */}
 <div className={`${roleColor.bg} border-2 ${roleColor.border || 'border-gray-200'} rounded-xl p-3 inline-flex items-center gap-3 shadow-sm transition-all min-w-[320px]`}>
 {/* Avatar */}
 ...
 <div className="mb-1">
 <span className={`inline-block px-2 py-0.5 text-xs font-bold rounded-xl ${roleColor.text} uppercase`}>
 {employee.role}
 </span>
 </div>
 {employee.email && (
 ...
 <div className="absolute left-0 top-0 w-6 h-1/2 border-l-2 border-b-2 border-gray-300 rounded-bl-lg"></div>
 <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-4 inline-block text-center">
