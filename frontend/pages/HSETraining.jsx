...
export default function HSETraining({ user }) {
    ...
    const closeModal = () => {
        ...
        _openGallery(items, "HSE Training Documents", "/api/hse/training/attachments");
    };
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="bg-white">
                                        {loading ? (
                                            ...
                                            return (
                                                <tr key={idx} className={`transition-colors ${isDeleting ? 'hse-training-deleting' : 'hover:bg-[var(--bg-primary)]/60'}`}>
                                                    {visibleColumns.checkbox && (
