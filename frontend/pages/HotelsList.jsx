 ...
 */}
 ...
 />
 <h1 className="text-3xl font-black text-slate-900 mt-1">Properties Dashboard</h1>
 <p className="text-sm text-gray-500 mt-1">Manage your hotel and property portfolio</p>
 </div>
 ...
 {/* Total Properties */}
 <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex items-center gap-4 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200">
 ...
 <option>Hotel Style</option>
  ...
  <div className="bg-white rounded-xl shadow-lg border border-gray-200 mb-8 px-4 py-3 flex items-center gap-4 transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5 hover:border-gray-300">
    ...
    {/* FILTER BUTTON */}
    <select className="border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-600 focus:border-emerald-200 focus:ring-2 focus:ring-emerald-300">
      <option>All Types</option>
      <option>Hotel Style</option>
      <option>Self-Contained</option>
    </select>
    ...
    {loading ? (
      ...
      filteredHotels.map((h) => {
        ...
        return (
          <div
            key={id}
            className={`bg-white rounded-xl p-5 shadow-sm border border-gray-100 relative group transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-gray-200 ${isDeleting ? 'hotels-list-card-deleting' : ''}`}
          >
            ...
            <div className="absolute top-4 right-4 card-menu z-10">
              ...
              {openMenuId === id && (
                <div
                  className="mt-2 w-40 bg-white rounded-xl shadow-xl border py-1 right-0 absolute z-50 animate-in fade-in zoom-in duration-200"
                  onClick={(e) => e.stopPropagation()}
                >
                  <button
                    onClick={() => openEditModal(h)}
                    className="flex items-center gap-2 w-full px-4 py-2 text-left hover:bg-gray-50 text-sm text-gray-700 rounded-xl"
                  >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="btn-secondary btn-sm w-10 !px-0 bg-white hover:!bg-red-50 hover:!text-red-500 hover:!border-red-200 rounded-xl"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
