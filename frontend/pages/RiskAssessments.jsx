                    ...
                    <div className="bg-white w-full max-w-md rounded-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between p-5 border-b border-gray-100">
                            ...
                            <button
                                ...
                                className="text-gray-400 transition-colors p-1 rounded-xl"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <div className="flex items-center justify-end gap-3 p-5 bg-gray-50 border-t border-gray-100">
                            <button
                                ...
                                className="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-medium transition-colors disabled:opacity-60"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="px-5 py-2.5 rounded-xl font-medium shadow-sm bg-rose-500 text-white disabled:opacity-60"
                            >
