...
export default function RiskAssessments({ user }) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      setDeleting(true);
      await api.delete(`/api/safeguarding/risk-assessments/${deleteId}`);
      await refreshAssessments();
                ...
                <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                  <tr className="border-b border-gray-200">
                    ...
                    {visibleColumns.priority && (
                      <th className="text-left py-4 px-4 text-xs font-semibold text-gray-600 uppercase tracking-wider">RISK LEVEL</th>
                    )}
