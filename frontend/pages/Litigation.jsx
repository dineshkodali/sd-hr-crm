                      ...
                      <tr key={task.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        {visibleColumns.description && (
                          <td className="py-4 px-4">
                            <div>
                              <div
                                className={`text-gray-900 font-medium cursor-pointer hover:text-teal-600 transition-colors`}
                                onClick={() => { setSelectedTask(task); setModalMode('edit'); setShowModal(true); }}
                              >
                                {task.title || "Litigation Case"}
                              </div>
                              <div className="text-gray-500 text-xs mt-1">
                                {task.description || "Litigation case details."}
                              </div>
                            </div>
                          </td>
                        )}
                        ...
                        {visibleColumns.date && (
                          <td className="py-4 px-4">
                            <span className="text-gray-700 text-sm">{formatDate(task.scheduled_date || task.date)}</span>
                          </td>
                        )}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl relative">
        ...
        {/* Modal Form Content */}
        <form id="lit-form" onSubmit={submit} className="p-4">
