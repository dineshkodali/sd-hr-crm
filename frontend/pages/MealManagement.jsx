...
export default function MealManagement({ user }) {
  ...
  //     await api
  //       .delete(`/api/meals/${encodeURIComponent(m.id)}`)
  //       .catch(() => null);
  //   } catch (err) {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 mt-1">
              ...
              <span>&gt;</span> <span>Meals</span> <span>&gt;</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-5 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-all duration-200 hover:shadow-2xl hover:-translate-y-1">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-gray-500 text-sm mb-1">Total Meals</div>
          ...
          <div className="bg-white p-5 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-all duration-200 hover:shadow-2xl hover:-translate-y-1">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-gray-500 text-sm mb-1">Consumed</div>
              <div className="text-2xl font-bold text-gray-900">{counts.consumed}</div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <input
                type="date"
                className="bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all"
                value={date}
      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-200">
        ...
        <div className="flex justify-between items-center p-6 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            {isConsumed ? (
              ...
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-100 text-amber-800 border border-amber-200 uppercase tracking-wide">
                Pending
              </span>
            )}
          </div>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="pt-6 border-t border-slate-100">
            <div className="text-xs uppercase font-semibold text-slate-400 mb-2 tracking-wider">
              Additional Notes
            </div>
        ...
        <div className="p-6 border-t border-slate-100 bg-slate-50/30 flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-white border border-slate-200 text-slate-700 font-medium rounded-lg shadow-sm hover:bg-slate-50 transition-colors"
          >
            Close
          </button>
        </div>
  ...
  useEffect(() => {
    if (initialData) {
      setForm({
        ...
        scheduledDate:
          initialData.scheduledDate || new Date().toISOString().slice(0, 10),
