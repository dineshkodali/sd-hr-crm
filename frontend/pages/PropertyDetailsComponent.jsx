...
export default function PropertyDetails({ property }) {
 ...
 const [realTotalFloors, setRealTotalFloors] = useState(totalFloors);
 ...
 const raw = r?.floor ?? r?.Floor ?? r?.floor_name ?? null;
 ...
 const floorsFromHotel = Number(
 hotelData?.total_floors ?? hotelData?.floors ?? hotelData?.no_of_floors ?? hotelData?.number_of_floors ?? totalFloors
 );
 const floorsResolved = Number.isFinite(floorsFromHotel) && floorsFromHotel > 0 ? floorsFromHotel : distinctFloors;
 setRealTotalFloors(floorsResolved || 0);

 const total = Number(hotelData?.total_beds ?? hotelData?.total_bed ?? hotelData?.beds ?? totalBedspaces) || 0;
 const occupied = Number(hotelData?.occupied_beds ?? hotelData?.occupied ?? hotelData?.occupied_bed ?? occupiedBeds) || 0;
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "overview"
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "floors"
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "residents"
 ? "bg-[#66f1dd] text-white shadow-sm"
 : "text-gray-600 hover:bg-gray-50"
 }`}
 >
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "maintenance"
 ? "bg-[#5cd9c7] text-white shadow-sm"
 : "text-gray-600 hover:bg-gray-50"
 }`}
 >
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "inspections"
 ? "bg-[#5cd9c7] text-white shadow-sm"
 : "text-gray-600 hover:bg-gray-50"
 }`}
 >
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "incidents"
 ? "bg-[#5cd9c7] text-white shadow-sm"
 : "text-gray-600 hover:bg-gray-50"
 }`}
 >
 ...
 className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${activeTab === "compliance"
 ? "bg-[#5cd9c7] text-white shadow-sm"
 : "text-gray-600 hover:bg-gray-50"
 }`}
 >
 ...
 >
 {errorMsg && (
 <div className="text-red-700 bg-red-50 p-3 rounded-xl text-sm">
 {errorMsg}
 </div>
 )}
 ...
 <select className="rounded-xl form-select">
 ...
 <input type="checkbox" className="rounded-xl sr-only peer" />
